...
<div class="panel">
        ...
        <tr class="even">
        	...
        	<td style="width:50%;">
        		<div class="select_all" id="cron_cmd_<?php echo $key; ?>"><?php echo 'curl '.$context->url($cron['url']); ?></div>
        	</td>
        	<td style="width:50%;">
        		<a href="<?php echo $context->url($cron['url']); ?>" class="test_cron" rel="<?php echo $key; ?>" id="cron_url_<?php echo $key; ?>">
